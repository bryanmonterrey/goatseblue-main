    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center p-4">
            <div className='absolute right-3 top-3 mb-6'>
                <Button className='border border-white py-1 px-4 rounded-none text-white hover:text-white hover:italic font-courier mx-auto'>
            ...
            <div className="block justify-center items-center">
                ...
                <div className="max-w-[350px] flex items-center justify-center">
                    <h1 className="text-white text-sm font-courier">
