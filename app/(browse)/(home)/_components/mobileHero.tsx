...
>
        ...
        <div className="relative min-h-[300vh]">
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center z-[1025]">
              <div className="relative pt-24 w-full h-full flex items-center justify-center">
                <AudioReactive3D audioUrl="/betterwith.mp3" />
              </div>
            </div>
          ...
          <div className='flex items-center justify-center min-h-screen bg-black space-y-3 min-w-screen mb-10'>
            ...
            <p ref={addToRefs}>Goatse Singularity is the end result. It is a digital AI economy that will spark and move crypto and AI forward. We've releases an AI equivalent to truth terminal which will be upgraded daily. One of our first products will be an AI trader and 
