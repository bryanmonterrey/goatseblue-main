...
>
        ...
        <div className="relative min-h-[300vh]">
          ...
          <div className='flex items-center justify-center min-h-screen space-y-3 min-w-screen'>
            ...
            <p ref={addToRefs}>We want to give you as much as we can without giving away our roadmap entirely away. This is actually a CTO with a dev takeover, and by dev, we mean an actual software developer. This term “developer” is used too loosely in the space and it’s okay we understand the space, we’ve only been apart of it since it started. Anyways, if you’d like to know about our developer’s stack it consists of 10+ years of writing code in not only Python, JavaScript and Typescript but also heavy experience in using React, NextJS, Tailwind and alot more frameworks. Our dev pretty much has the same experience in design as well.</p>

            <p ref={addToRefs}>Goatse Singularity is the end result. It is a digital AI economy that will spark and move crypto and AI forward. There will be continuous and lifelong incentive to hold and you’re early. We plan on launching several AI products and a complete digital AI brand that will set the standard for AI companies not only in the crypto space but the entire AI space. We don’t bash other coins/tokens but we’ve seen the competition and feel like we can bring a lot to the space and deliver 75% of the total AI infrastructure crypto will grow to have. We're here to give our hodlers something the didn't even know they wanted. </p>
          </div>
